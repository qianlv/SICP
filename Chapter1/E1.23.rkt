...
; this section does lots of needless testing: After it
; checks to see if the number is divisible by 2 there is
; no point in checking to see if it is divisible by any
; larger even numbers. This suggests that the values used
; for test-divisor should not be 2, 3, 4, 5, 6, . . .,
...
; found in Exercise 1.22. Since this modification halves
